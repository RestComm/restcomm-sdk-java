...
public class Number {
	...
	public Number url(String url) {
		this.url = url;
		return this;
	}
	public Number method(MethodType method) {
	...
	public Number statusCallbackMethod(MethodType method) {
		this.statusCallbackMethod = method.name();
		return this;
	}
	public Number statusCallbackMethod(String value) {
		this.value = value;
		return this;
	}
	@Override
	public String toString() {
		return "Number [sendDigits=" + sendDigits + ", url=" + url + ", method=" + method + ", statusCallbackEvent="
